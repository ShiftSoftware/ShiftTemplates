...
using ShiftTemplates.Builder.Migrator;
...
namespace ShiftTemplates.Builder.Migrator.Migrations
{
    ...
    [Migration("20260609160343_Auto_20260609160326")]
    partial class Auto_20260609160326
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Test.Data.Entities.Country", b =>
                {
                    b.Property<long>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Test.Data.Entities.InvoiceLine", b =>
                {
                    b.Property<long>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Test.Data.Entities.ProductBrand", b =>
                {
                    b.Property<long>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Test.Data.Entities.ProductCategory", b =>
                {
                    b.Property<long>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Test.Data.Entities.InvoiceLine", b =>
                {
                    b.HasOne("Test.Data.Entities.Invoice", "Invoice")
                        .WithMany("InvoiceLines")
                        .HasForeignKey("InvoiceID")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Test.Data.Entities.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("Test.Data.Entities.Product", b =>
                {
                    b.HasOne("Test.Data.Entities.Country", "CountryOfOrigin")
                        .WithMany()
                        .HasForeignKey("CountryOfOriginID");

                    b.HasOne("Test.Data.Entities.ProductBrand", "ProductBrand")
                        .WithMany()
                        .HasForeignKey("ProductBrandID")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Test.Data.Entities.ProductCategory", "ProductCategory")
                        .WithMany("Products")
