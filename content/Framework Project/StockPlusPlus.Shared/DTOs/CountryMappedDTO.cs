...
// Same shape as CountryDTO, but a DISTINCT type so the "custom mapper" endpoint at "api/countrymapped"
// is fully isolated from the plain endpoint at "api/country" (both over the same Country table).
