...
| [`02-open-decisions.md`](02-open-decisions.md) | The judgment calls the team must make — Q5/Q6 dropped as consumer-scope, Q9/Q10 added by the rescope. Several steps are blocked on them. Recommendations included. |
...
3. **The escape hatches still get built, even though nothing in scope uses them.** A5/A6's diagnostics, A7's
   ...
   scope quietly strands everyone downstream. (All three shipped with Stage A.)
